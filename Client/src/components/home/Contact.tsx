      ...
      <div className="container text-center justify-center px-4">
        <AnimatedSection>
          ...
          <p className="text-black max-w-xl mx-auto mb-12 dark:text-white">
            Having questions or need more information? We're here to help. Reach out to us and we'll get back to you as
            soon as possible.
          </p>
        </AnimatedSection>
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            {/* Contact Information */}
            <AnimatedSection animation="slide-up" className="lg:col-span-2 flex items-center justify-center">
              <div className="w-full max-w-md bg-estg-gray-light dark:bg-secondary rounded-2xl p-8 mx-auto">
                <h3 className="text-2xl font-display font-semibold mb-6 dark:text-white text-center">
                  Contact Information
                </h3>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                  <h4 className="font-medium mb-3 dark:text-white text-center">Connect With Us</h4>
